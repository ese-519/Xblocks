		...
		case 0xBE: // READ SCRATCHPAD
			sendData(scratchpad, 9);
				if (errno != ONEWIRE_NO_ERROR)
					return FALSE;
			break;
    case 0xA2://NEW CODE BLINK LED READ SWITCH COUNTER SEND SCRATCHPAD
      ...
      DIRECT_MODE_INPUT(portInputRegister(digitalPinToPort(0)),digitalPinToBitMask(0));
      if(DIRECT_READ(portInputRegister(digitalPinToPort(0)),digitalPinToBitMask(0))){
        scratchpad[7] = 0x01;
      }
      else{
        scratchpad[7] = 0x00;
